...
var headerEl = document.querySelector(".header"); // toggle - переключать 
...
var sectionHeroEl = document.querySelector(".section-hero"); // Мы выбираем что будем следить за данным параметром и если он false то есть мы листанули вниз , а изначально он был true , и когда он возвращается ии изначально сверху то опять становится true и удаляется класс stiky
...
var obs = new IntersectionObserver(function (entries) {
  ...
  if (ent.isIntersecting === false) {
    document.body.classList.add('sticky'); // Можно заменить одним if добавив отрицание ! сверху
  }
...
obs.observe(sectionHeroEl); ////////////////////////////Код ниже лучше везде вставлять , так как sfafari не поддерживает gap свойство во felxbox 
///////////////////////////////////////////////////////////
